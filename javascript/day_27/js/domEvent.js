...
var item = wrapper.querySelector(".item a"); // Thẻ a
...
var fromLogin = document.querySelector(".from_login");
var fromCreate = document.querySelector(".from_create_account");
...
function checkMail() {
  ...
  // else if (checkMailLogin === null) {
  //     checkMailLogin.innerText = "Xin vui lòng nhập vào Email !";

  //   // checkMailLogin.classList.replace("close", "open");
  // }
}
